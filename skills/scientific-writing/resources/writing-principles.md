...
### 3. Avoiding AI-Sounding Writing

Scientific writing must read like a human wrote it. For the full evidence-based guide (peer-reviewed research, AI fingerprints, voice preservation strategies, field-specific advice), see `ai-human-writing-guide.md`. This section is the quick-reference checklist.

**Top AI filler phrases to delete on sight:**

| AI Filler | Fix |
|-----------|-----|
| "It is important to note that" | Delete. State the point. |
| "It is worth mentioning that" | Delete. |
| "plays a crucial role in" | Say what it does ("regulates", "inhibits"). |
| "has gained significant attention" | Say who noticed it and when. |
| "sheds light on" / "paves the way for" | Replace with the specific verb/consequence. |
| "delve into" | Replace with "examine", "analyze". |
| "navigate the complexities of" | Say what is complex and why. |
| "harness the power of" / "leverage" / "utilize" | Use "use", "apply". |
| "a multifaceted approach" / "a myriad of" | Name the facets / use a number. |
| "bridge the gap" / "unprecedented" | Say which gap / provide the comparison. |

**Lexical tells to avoid:** delve, tapestry, landscape (metaphorical), robust (as generic praise), pivotal, intricate, nuanced, holistic, facilitate.

**Structural patterns to vary:**
- Sentence length (mix 5-word and 30-word sentences)
- Paragraph length (mix 1-sentence and 7-sentence paragraphs)
- Paragraph openers (not all "Furthermore"/"Moreover"/"Additionally" — circle openers; if >2/5 start with a transition, rewrite)
- Claim strength (hedge uncertain findings strongly, state solid findings plainly)
- Section symmetry (real science is asymmetric — some findings need 3 paragraphs, others 1 sentence)
- Rhetorical questions (delete them — state the finding)
- "Not only... but also" (max once per section)

**De-AI checklist (run before delivery):**
- [ ] No AI filler phrases or lexical tells
- [ ] Paragraph openers varied (not all transitions)
- [ ] Sentence and paragraph length varies meaningfully
- [ ] No rhetorical questions
- [ ] Adjectives are specific ("12% reduction" not "significant reduction" alone)
- [ ] Read aloud: sounds like a person talking about their research

### 4. Hedging Excessively or Insufficiently
...
4. **Technical conferences** (engineering, CS)
...
**Example opening (technical conference style):**
```
