...
| **Engineering conferences** | Engineering/CS | Numbered [1] or (Author, Year) | Varies by venue, check template |
...
- **Engineering/CS conferences**: ArXiv preprints widely cited; recent work heavily valued
...
- **Engineering/CS conferences**: 25-40 references typical for shorter papers
