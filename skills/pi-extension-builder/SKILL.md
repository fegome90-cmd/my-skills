...
Design, implement, and audit TypeScript extensions for the pi coding agent. 18 verified packs extracted from real production extensions.
...
Load `resources/packs-core.md` for the 10 essential packs.
...
Load `resources/packs-advanced.md` for advanced packs (TUI, sessions, compaction, child processes).
...
|------|------|----------|--------|
| **START HERE** — any extension | Pack 1: Minimal Handler | `packs-core.md` | — |
| Expose a function to the LLM | Pack 2: Tool Registration | `packs-core.md` | — |
| Add a `/slash` command | Pack 3: Command Registration | `packs-core.md` | — |
| Add a custom model provider | Pack 4: Provider | `packs-core.md` | `openrouter.ts` |
| Block or audit LLM tool calls | Pack 5: Tool Guard | `packs-core.md` | `tool-guard.ts` |
...
| React to first user message | Pack 8: Session Name | `packs-core.md` | `auto-session-name.ts` |
| Periodic background check | Pack 9: Periodic Check | `packs-core.md` | `auto-update.ts` |
| Talk to other extensions | Pack 10: Inter-Extension RPC | `packs-core.md` | `pi-tasks` pattern |
| Custom footer status bar | Pack 11: Footer | `packs-advanced.md` | `custom-footer.ts` |
| Custom header display | Pack 12: Header | `packs-advanced.md` | `compact-header.ts` |
| Session management + events | Pack 13: Session Hub | `packs-advanced.md` | `context-session-hub.ts` |
| Persist across compaction | Pack 14: Compaction Hook | `packs-advanced.md` | `00-compact-memory-bridge.ts` |
| Extension > 300 lines | Pack 15: Multi-File Package | `packs-advanced.md` | `subagent-statusline/` |
| Inject context into turns | Pack 16: System Prompt Injection | `packs-advanced.md` | `context-loader.ts` |
| Temporary UI panel | Pack 17: TUI Widget | `packs-advanced.md` | `n8n-mcp-helper.ts` |
