...
class TestVerifyCitation:
    ...
    @patch("resources.scoring._crossref_lookup")
    ...
    @patch("resources.scoring._pubmed_lookup")
    ...
    def test_doi_takes_priority_over_pmid(self) -> None:
        ...
        with patch("resources.scoring._crossref_lookup") as mock_cr, \
             patch("resources.scoring._pubmed_lookup") as mock_pm:
